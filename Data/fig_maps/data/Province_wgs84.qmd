...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="File Geodatabase Feature Class" url="file://\\DELL-PC\C$\Users\dell\Desktop\ljw\???????2014.gdb" description="" mimeType="" type="Local Area Network" size="" format=""/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial maxy="0" crs="" minx="0" miny="0" maxz="0" dimensions="2" minz="0" maxx="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
